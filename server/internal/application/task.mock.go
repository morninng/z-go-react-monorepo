...
import (
	...
	application "github.com/morninng/z-go-react-monorepo/internal/application"
...
func (m *MockTaskApplicationService) PostMany(c context.Context, cmd application.TaskSaveCommand) error {
	m.ctrl.T.Helper()
